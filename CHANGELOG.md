...
- Cleaned up agent trace budgeting so the runtime no longer carries a dead conditional while copying `taskState` into trace metadata, reducing warning noise without changing behavior.
