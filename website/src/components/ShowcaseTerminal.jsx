...
const scenarios = [
    ...
    },
    {
        ...
        trace: [
            ...
            { tool: 'discord_get_voice_analytics', status: 'ok', text: 'Found 2 sessions: #general-voice (45min), #dev-talk (20min)' },
            { tool: 'discord_get_channel_memory', status: 'ok', text: 'Loading rolling summary for #general around session timestamp' },
            { tool: 'discord_search_channel_messages', status: 'ok', text: 'Semantic search: messages near voice session window' },
    ...
    },
    {
        ...
        trace: [
            ...
            { tool: 'github_get_file', status: 'ok', text: 'Reading src/core/agentRuntime/defaultTools.ts (24 tools)' },
