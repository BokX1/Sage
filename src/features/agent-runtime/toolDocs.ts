...
export const discordAdminToolDoc = registerRoutedToolDoc({
  ...
  actions: [
    ...
    },
    {
      ...
      avoidWhen: ['You only need to read the current instruction text; use discord_context.get_server_instructions instead.'],
      ...
      commonMistakes: ['Do not use this when you only need to inspect the current instructions; that is a discord_context read.'],
    },
    {
    ...
    },
    {
      ...
      avoidWhen: ['A typed action already covers the task.', 'The task is normal message sending.', 'You have not checked the typed discord_server/discord_admin actions yet.'],
      ...
      commonMistakes: ['Do not use api for normal message sending; use discord_messages send.', 'Do not use api before checking typed discord_server or discord_admin actions.', 'Do not assume api is available in non-admin turns.'],
    },
  ],
});
