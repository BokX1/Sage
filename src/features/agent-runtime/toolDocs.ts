...
export const discordContextToolDoc = registerRoutedToolDoc({
  ...
  actions: [
    ...
    },
    {
      ...
      examples: [{ action: 'get_server_instructions' }],
    ...
    },
    {
      ...
      requiredFields: ['action'],
      optionalFields: ['userId', 'maxEdges'],
      defaults: ['userId defaults to the current user.'],
    ...
    },
    {
      ...
      requiredFields: ['action'],
      optionalFields: ['voiceChannelId', 'sinceHours', 'limit'],
...
export const discordMessagesToolDoc = registerRoutedToolDoc({
  ...
  actions: [
    ...
    },
    {
      ...
      requiredFields: ['action', 'query'],
      optionalFields: ['channelId', 'topK', 'mode', 'regexPattern', 'sinceIso', 'untilIso', 'sinceHours', 'sinceDays'],
    ...
    },
    {
      ...
      requiredFields: ['action', 'query'],
      optionalFields: ['channelId', 'topK', 'mode', 'regexPattern', 'sinceIso', 'untilIso', 'sinceHours', 'sinceDays', 'before', 'after'],
    ...
    },
    {
      ...
      optionalFields: ['channelId', 'before', 'after'],
    ...
    },
    {
      ...
      requiredFields: ['action', 'query'],
      optionalFields: ['topK', 'mode', 'regexPattern', 'sinceIso', 'untilIso', 'sinceHours', 'sinceDays'],
    ...
    },
    {
      ...
      requiredFields: ['action'],
      optionalFields: ['userId', 'limit', 'sinceIso', 'untilIso', 'sinceHours', 'sinceDays'],
      defaults: ['userId defaults to the current user.'],
      restrictions: ['Disabled in autopilot turns.', 'Provide at most one of sinceIso, sinceHours, or sinceDays.'],
...
export const discordFilesToolDoc = registerRoutedToolDoc({
  ...
  actions: [
    ...
    },
    {
      ...
      requiredFields: ['action'],
      optionalFields: ['query', 'messageId', 'filename', 'limit', 'includeContent'],
      defaults: ['Operates on the current channel only.'],
    ...
    },
    {
      ...
      optionalFields: ['startChar'],
      restrictions: ['Disabled in autopilot turns.'],
      resultNotes: ['Use returned continuation fields to continue paging when more content exists.'],
      examples: [{ action: 'read_attachment', attachmentId: 'att-123', startChar: 0 }],
    },
    {
      ...
      requiredFields: ['action', 'attachmentId'],
      optionalFields: ['channelId', 'content', 'reason', 'startChar'],
      defaults: ['channelId defaults to the current channel.'],
      restrictions: ['Disabled in autopilot turns.'],
...
export const webToolDoc = registerRoutedToolDoc({
  ...
  actions: [
    ...
    },
    {
      ...
      examples: [{ action: 'read', url: 'https://example.com/docs' }],
    },
    {
      action: 'read.page',
      ...
      requiredFields: ['action', 'url'],
      optionalFields: ['contentId', 'startChar'],
      resultNotes: ['Use contentId + nextStartChar from the result to continue paging.'],
      examples: [{ action: 'read.page', url: 'https://example.com/docs', startChar: 0 }],
    ...
    },
    {
      ...
      requiredFields: ['action', 'query'],
      optionalFields: ['depth', 'maxResults', 'maxSources', 'followLinks', 'maxFollowedLinks', 'maxFollowedLinksPerSource', 'followSameDomainOnly'],
...
export const githubToolDoc = registerRoutedToolDoc({
  ...
  actions: [
    ...
    },
    {
      ...
      optionalFields: ['ref', 'startLine', 'endLine', 'includeLineNumbers'],
    ...
    },
    {
      ...
      requiredFields: ['action', 'repo', 'path'],
      optionalFields: ['ref', 'startLine', 'maxLines', 'includeLineNumbers'],
    ...
    },
    {
      ...
      optionalFields: ['ref', 'includeLineNumbers'],
    ...
    },
    {
      ...
      optionalFields: ['ref', 'before', 'after', 'includeLineNumbers'],
