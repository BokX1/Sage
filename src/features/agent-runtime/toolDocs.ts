...
export const discordAdminToolDoc = registerRoutedToolDoc({
  ...
  actions: [
    ...
    },
    {
      ...
      useWhen: ['The task is a moderation workflow rather than a generic Discord write.', 'A replied-to message should be deleted or acted on for spam, abuse, harassment, or rule enforcement.'],
