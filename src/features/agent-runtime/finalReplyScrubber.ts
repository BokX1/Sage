...
const OPERATIONAL_REPLY_LINE_REGEXES = [
  ...
  /^\s*(?:Calling|Using|Invoking|Running)\b.+\b(?:tool|runtime_execute_code|discord\.[a-z0-9_.]+|history\.[a-z0-9_.]+|context\.[a-z0-9_.]+|artifacts\.[a-z0-9_.]+|approvals\.[a-z0-9_.]+|admin\.[a-z0-9_.]+|moderation\.[a-z0-9_.]+|schedule\.[a-z0-9_.]+|http\.fetch|workspace\.[a-z0-9_.]+|discord_[a-z_]+|web_[a-z_]+|repo_[a-z_]+|browser_[a-z_]+|docs_lookup|mcp__[a-z0-9_]+__[a-z0-9_]+|npm_info|system_time|system_tool_stats|image_generate)\b/i,
