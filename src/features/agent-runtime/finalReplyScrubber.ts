...
const OPERATIONAL_REPLY_LINE_REGEXES = [
  ...
  /^\s*(?:Calling|Using|Invoking|Running)\b.+\b(?:tool|discord_[a-z_]+|web_[a-z_]+|github_[a-z_]+|workflow_[a-z_]+|wikipedia_search|stack_overflow_search|npm_info|system_time|system_tool_stats|image_generate)\b/i,
