...
const OPERATIONAL_REPLY_LINE_REGEXES = [
  ...
  /^\s*(?:Calling|Using|Invoking|Running)\b.+\b(?:tool|runtime_execute_code|discord\.[a-z0-9_.]+|history\.[a-z0-9_.]+|context\.[a-z0-9_.]+|artifacts\.[a-z0-9_.]+|approvals\.[a-z0-9_.]+|admin\.[a-z0-9_.]+|moderation\.[a-z0-9_.]+|schedule\.[a-z0-9_.]+|http\.fetch|workspace\.[a-z0-9_.]+)\b/i,
