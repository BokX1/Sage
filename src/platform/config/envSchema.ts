...
export const envSchema = z.object({
  ...
  OPENAI_CODEX_AUTH_CLIENT_ID: z.string().trim().optional(),
  OPENAI_CODEX_AUTH_AUTHORIZE_URL: httpsUrlSchema.default('https://auth.openai.com/oauth/authorize'),
  OPENAI_CODEX_AUTH_TOKEN_URL: httpsUrlSchema.default('https://auth.openai.com/oauth/token'),
  OPENAI_CODEX_AUTH_REDIRECT_URI: z.string().trim().url().default('http://127.0.0.1:1455/auth/callback'),
