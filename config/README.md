...
| `config/services/self-host/` | Optional self-hosted provider stack for search, scrape, and file-ingest services. | `docs/operations/TOOL_STACK.md`, `.env` self-host profiles |
