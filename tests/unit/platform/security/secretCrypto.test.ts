...
describe('secret crypto', () => {
  ...
  it('encrypts/decrypts with a configured key', async () => {
    ...
    const { encryptSecret, decryptSecret } = await import('../../../../src/platform/security/secret-crypto');
  ...
  it('rejects unencrypted values', async () => {
    ...
    const { decryptSecret } = await import('../../../../src/platform/security/secret-crypto');
