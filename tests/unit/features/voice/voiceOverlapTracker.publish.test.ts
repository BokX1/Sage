...
vi.mock('@/features/voice/voicePresenceIndex', () => ({
  getGuildPresence: mockGetGuildPresence,
}));

import { computeVoiceOverlapForUser } from '@/features/voice/voiceOverlapTracker';
import {
  setSocialGraphPublisherForTests,
  type SocialGraphPublisher,
  type VoiceSessionEvent,
} from '@/platform/social-graph/kafkaProducer';
