...
describe('transcriptBuilder', () => {
  it('uses the Discord @me token for DM jump-link references', () => {
    ...
    expect(block).toContain('speaker:other guild:@me ch:dm-channel-1 msg:msg-1');
  });
  ...
  it('renders speaker class, reply linkage, and mentions for transcript lines', () => {
    ...
    expect(block).toContain('speaker:other guild:guild-1 ch:channel-1 msg:msg-3 reply_to:msg-2 mentions:none');
    expect(block).toContain('speaker:system guild:guild-1 ch:channel-1 msg:msg-4 reply_to:none mentions:none');
