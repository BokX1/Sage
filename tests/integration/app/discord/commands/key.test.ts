...
describe('key command handlers', () => {
  ...
  it('normalizes invalid profile timeout inputs to safe bounds', async () => {
    const { resolveProfileTimeoutMs } = await import('@/app/discord/commands/api-key-handlers');
  ...
  it('includes zero pollen balance when setting a key', async () => {
    ...
    const { handleKeySet } = await import('@/app/discord/commands/api-key-handlers');
  ...
  it('denies key status checks for non-admin users', async () => {
    ...
    const interaction = createInteraction();
    const { handleKeyCheck } = await import('@/app/discord/commands/api-key-handlers');
  ...
  it('guides admins to reconfigure a key after clearing it', async () => {
    const interaction = createInteraction();
    const { handleKeyClear } = await import('@/app/discord/commands/api-key-handlers');
